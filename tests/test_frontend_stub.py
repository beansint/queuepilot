...
exactly the path that always runs in this environment: the catch-all placeholder route.
...
def test_unknown_path_serves_placeholder_when_no_dist() -> None:
...
def test_analyze_route_not_shadowed_by_placeholder(monkeypatch: object) -> None:
    """/analyze (POST) is matched before the catch-all GET placeholder."""
