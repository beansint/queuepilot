...
- **Dense vector:** Voyage `voyage-3.5-lite`, dimension **1024** (registry-swappable; Gemini
  `gemini-embedding-001` @ 768 dims is a drop-in — see D11). Do not change without a full
  Pinecone re-index.
